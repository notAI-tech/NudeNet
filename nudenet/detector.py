...
class Detector():
    ...
    def __init__(self, model_name='default'):
        ...
        Detector.detection_model = models.load_model(checkpoint_path, backbone_name='resnet50')
        Detector.classes = [c.strip() for c in open(classes_path).readlines() if c.strip()]
